        ...
        <div className="p-6 border-b border-zinc-100 dark:border-zinc-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="relative flex-1 max-w-md">
            ...
            <input 
              ...
              className="w-full pl-12 pr-4 py-3 bg-zinc-50 dark:bg-zinc-800/50 border-transparent rounded-2xl text-sm font-medium focus:ring-4 focus:ring-brand/10 focus:border-brand/20 transition-all outline-none"
            />
          </div>
              ...
              <form onSubmit={handleAddRecord} className="p-8 space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <select 
                      ...
                      className="w-full px-5 py-4 bg-zinc-50 dark:bg-zinc-800/50 border-2 border-transparent focus:border-brand rounded-2xl text-sm font-bold outline-none transition-all"
                    >
                      {types.map(t => (
                        <option key={t.value} value={t.value}>{t.label}</option>
                      ))}
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    className="w-full px-5 py-4 bg-zinc-50 dark:bg-zinc-800/50 border-2 border-transparent focus:border-brand rounded-2xl text-sm font-bold outline-none transition-all resize-none h-32"
                  />
                </div>
