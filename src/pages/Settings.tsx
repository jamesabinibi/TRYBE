...
NOTIFY pgrst, 'reload schema';
  ...
  const handleSelectLogo = (logo: string) => {
    setLogoPreview(logo);
    setSettings(prev => ({ ...prev, logo_url: logo }));
    toast.success('Logo selected! Click "Save Business Logo" to apply it.');
  };
          ...
          <div className="bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl sm:rounded-[2.5rem] border border-zinc-200 dark:border-zinc-800 shadow-sm">
            <div className="flex flex-col items-center text-center space-y-6">
              ...
              <div className="flex flex-col items-center gap-6 w-full">
                ...
                {/* AI Logo Generator */}
                <div className="w-full pt-8 border-t border-zinc-100 dark:border-zinc-800 space-y-6">
